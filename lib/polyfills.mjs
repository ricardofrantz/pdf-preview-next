...
// RegExp.escape is part of the Baseline 2025 JavaScript set and is used by
// PDF.js find-query handling. VS Code 1.95's Electron runtime does not ship it.
// Without these polyfills, opening PDFs or searching for punctuation can throw
